...
public class BrackenSproutsBowlItem extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack pStack, Level pLevel, LivingEntity pLivingEntity) {
        ...
        if (!pLevel.isClientSide()) {
            pLivingEntity.addEffect(new MobEffectInstance(ModEffects.DIARRHEA.get(), DIARRHEA_DURATION_TICKS, 0, false, true));
            pLivingEntity.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, BLINDNESS_DURATION_TICKS, 0, false, true));
        }
